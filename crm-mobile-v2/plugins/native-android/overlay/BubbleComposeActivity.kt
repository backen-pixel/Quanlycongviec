...
/**
 * Composer chat trong Activity — bàn phím + chọn ảnh hoạt động giống ChatDetailScreen.
 * Overlay panel ẩn tạm khi Activity này mở.
 */
class BubbleComposeActivity : Activity() {
  ...
  private fun buildUi(replySender: String, replyText: String): Pair<FrameLayout, LinearLayout> {
    ...
    reply.addView(TextView(this).apply {
      text = if (replySender.isNotBlank()) "Trả lời $replySender" else "Trả lời"
