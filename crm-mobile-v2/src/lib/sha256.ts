/**
 * SHA-256 thuần JS — hash file APK theo từng chunk (không cần expo-crypto).
 */
...
export function createSha256() {
  ...
  function update(chunk: Uint8Array) {
    ...
    while (offset + 64 <= chunk.length) {
      processBlock(chunk.subarray(offset, offset + 64));
      offset += 64;
    }
...
export function normalizeSha256Hex(value: string | null | undefined): string {
