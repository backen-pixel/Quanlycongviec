...
type QuickItem = {
  ...
  sparkKey?: 'won_value' | 'deal_count' | 'lead_count';
...
export default function ReportQuickOverview({ summary, compare, timeline = [] }: Props) {
  ...
  const items: QuickItem[] = useMemo(() => [
...

    {
      ...
      value: String(summary.reception_eligible_count ?? 0),

      icon: 'call-outline',

      accent: '#60A5FA',

      compareKey: 'reception_eligible_count',
...

    {
      ...
      value: String(summary.completed_deal_count ?? 0),
