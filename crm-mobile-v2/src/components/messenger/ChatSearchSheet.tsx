    ...
    () =>
      StyleSheet.create({
        ...
        searchWrap: {
          ...
          backgroundColor: isDark ? colors.card : colors.surfaceSoft,
        },
        ...
        rowName: { color: colors.blue, fontSize: 13, fontWeight: '700', flex: 1 },
        ...
        <Pressable style={styles.sheet} onPress={(e) => e.stopPropagation()}>
          ...
          <View style={styles.head}>
            ...
            <Pressable onPress={onDismiss} hitSlop={8}>
              <Text style={{ color: colors.blue, fontWeight: '700' }}>Huỷ</Text>
            </Pressable>
          </View>
