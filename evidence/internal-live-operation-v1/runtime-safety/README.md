...
Tracked files describe the evidence contract. Generated artifacts belong in `runtime/`, which is Git-ignored so a local verification run does not dirty the frozen checkout.
