  ...
  return withAndroidManifest(config, (cfg) => {
    ...
    app.service = app.service.filter((s) => {
      ...
      return (
        ...
        && n !== 'vn.tubeppro.vcmobile.overlay.SxFirebaseMessagingService'
      );
    });
    ...
    if (!app.activity.some((a) => a.$?.['android:name'] === '.overlay.BubbleComposeActivity')) {
      app.activity.push({
        $: {
          ...
          'android:taskAffinity': 'vn.tubeppro.vcmobile.bubblecompose',
        },
      });
    }
    ...
    if (!app.activity.some((a) => a.$?.['android:name'] === '.overlay.BubbleMediaPickerActivity')) {
      app.activity.push({
        $: {
          ...
          'android:excludeFromRecents': 'true',
          'android:taskAffinity': 'vn.tubeppro.vcmobile.bubblepicker',
        },
      });
    }
