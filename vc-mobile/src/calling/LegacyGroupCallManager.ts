...
export class LegacyGroupCallManager {
  ...
  private getOrCreatePc(callId: string, peerId: string, name: string, media: CallMedia): PeerEntry {
    ...
    type PcHandlers = RTCPeerConnection & {
      onicecandidate: ((e: { candidate?: RTCIceCandidate | null }) => void) | null;
      ontrack: ((e: { track?: MediaStreamTrack; streams?: MediaStream[] }) => void) | null;
      onconnectionstatechange: (() => void) | null;
    };
    const pc = new RTCPeerConnection({ iceServers: [] }) as PcHandlers;
