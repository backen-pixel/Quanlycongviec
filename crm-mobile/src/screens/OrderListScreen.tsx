  ...
  return (
    <View style={styles.screen}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={[styles.row, CrmShadow.card]} onPress={() => navigation.navigate('OrderDetail', { id: item.id })}>
            <View style={styles.rowTop}>
              <Text style={styles.code}>{item.code}</Text>
              <View style={styles.badge}>
                <Text style={styles.badgeTxt}>{ST[item.status || ''] || item.status || '—'}</Text>
              </View>
            </View>
