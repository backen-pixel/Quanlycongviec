...
const TYPE_ICON: Record<string, IonName> = {
  ...
  production_task_deadline_warning: 'time-outline',
  production_task_deadline_overdue: 'warning-outline',
  logistics_task_deadline_warning: 'time-outline',
  logistics_task_deadline_overdue: 'warning-outline',
  project_pipeline_deadline_warning: 'time-outline',
  project_pipeline_deadline_overdue: 'warning-outline',
...
const TYPE_TINT: Record<string, NotifTint> = {
  ...
  production_task_deadline_warning: { bg: CrmColors.amber100, fg: CrmColors.amber600 },
  production_task_deadline_overdue: { bg: CrmColors.red50, fg: CrmColors.red500 },
  logistics_task_deadline_warning: { bg: CrmColors.amber100, fg: CrmColors.amber600 },
  logistics_task_deadline_overdue: { bg: CrmColors.red50, fg: CrmColors.red500 },
  project_pipeline_deadline_warning: { bg: CrmColors.amber100, fg: CrmColors.amber600 },
  project_pipeline_deadline_overdue: { bg: CrmColors.red50, fg: CrmColors.red500 },
