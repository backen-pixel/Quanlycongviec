/**
 * Xuất PDF hướng dẫn Không gian chung.
 * Chạy: node docs/ba/guides/huong-dan-khong-gian-chung/generate-pdf.mjs
 */
import fs from 'fs';
...
const srcHtml = path.join(__dirname, 'HUONG_DAN_KHONG_GIAN_CHUNG.print.html');
const outPdf = path.join(__dirname, 'HUONG_DAN_KHONG_GIAN_CHUNG.pdf');
...
await page.pdf({
  ...
  footerTemplate:
    '<div style="width:100%;font-size:8px;color:#94a3b8;text-align:center;padding:0 14mm;"><span>TuBep Pro — Không gian chung</span> · <span class="pageNumber"></span>/<span class="totalPages"></span></div>',
});
await browser.close();
