...
const INTENTIONAL_POST_SPLIT = [
  ...
  { method: 'GET', path: '/error-types', reason: 'Post-split product: danh mục loại lỗi', file: 'routes/errorTypes.js' },
  { method: 'POST', path: '/error-types', reason: 'Post-split product: tạo loại lỗi', file: 'routes/errorTypes.js' },
  { method: 'PUT', path: '/error-types/:id', reason: 'Post-split product: cập nhật loại lỗi', file: 'routes/errorTypes.js' },
  { method: 'DELETE', path: '/error-types/:id', reason: 'Post-split product: xoá loại lỗi', file: 'routes/errorTypes.js' },
  { method: 'PUT', path: '/error-types/:id/staff', reason: 'Post-split product: phân công loại lỗi', file: 'routes/errorTypes.js' },
  { method: 'GET', path: '/deals/spawn-source-ids', reason: 'Post-split product: nguồn deal phát sinh', file: 'routes/leadLifecycle.js' },
  { method: 'POST', path: '/deals/:id/spawn-additional', reason: 'Post-split product: tạo deal phát sinh', file: 'routes/leadLifecycle.js' },
  { method: 'GET', path: '/deals/:id/spawned-additional', reason: 'Post-split product: danh sách deal phát sinh', file: 'routes/leadLifecycle.js' },
  { method: 'GET', path: '/leads/:id/inbox-links', reason: 'Post-split product: liên kết inbox của lead', file: 'routes/leadLifecycle.js' },
  { method: 'GET', path: '/leads/:id/transfer-options', reason: 'Post-split product: tuỳ chọn chuyển phụ trách', file: 'routes/leadLifecycle.js' },
  { method: 'PATCH', path: '/leads/:id/deadline/disable-all', reason: 'Post-split product: tắt deadline lead', file: 'routes/leadLifecycle.js' },
  { method: 'GET', path: '/leads/search-suggest', reason: 'Post-split product: gợi ý tìm kiếm lead', file: 'routes/leadsList.js' },
  { method: 'GET', path: '/leads/stage-counts', reason: 'Post-split product: đếm lead theo stage', file: 'routes/leadsList.js' },
  { method: 'GET', path: '/filter-summary', reason: 'Post-split product: tổng hợp bộ lọc CRM', file: 'routes/leadsList.js' },
  { method: 'POST', path: '/deadline-bucket-counts', reason: 'Post-split product: đếm bucket deadline', file: 'routes/leadsList.js' },
  { method: 'POST', path: '/deadline-bucket-pages', reason: 'Post-split product: phân trang bucket deadline', file: 'routes/leadsList.js' },
  { method: 'POST', path: '/kpi-ledger-total', reason: 'Post-split product: tổng KPI ledger', file: 'routes/leadsList.js' },
  { method: 'POST', path: '/kanban-stage-pages', reason: 'Post-split product: phân trang Kanban stage', file: 'routes/leadsList.js' },
  { method: 'GET', path: '/phat-sinh-kinds', reason: 'Post-split product: danh mục phát sinh', file: 'routes/phatSinhKinds.js' },
  { method: 'POST', path: '/phat-sinh-kinds', reason: 'Post-split product: tạo loại phát sinh', file: 'routes/phatSinhKinds.js' },
  { method: 'PUT', path: '/phat-sinh-kinds/:id', reason: 'Post-split product: cập nhật loại phát sinh', file: 'routes/phatSinhKinds.js' },
  { method: 'DELETE', path: '/phat-sinh-kinds/:id', reason: 'Post-split product: xoá loại phát sinh', file: 'routes/phatSinhKinds.js' },
  { method: 'GET', path: '/leads/:id/qualification', reason: 'Business OS pilot: đọc trạng thái Qualification', file: 'routes/salesQualificationPilot.js' },
  { method: 'PUT', path: '/leads/:id/qualification/custom-fields', reason: 'Business OS pilot: lưu Dynamic Custom Fields có tenant scope', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/qualification/start', reason: 'Business OS pilot: bắt đầu Qualification', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/qualification/complete', reason: 'Business OS pilot: hoàn tất Qualification', file: 'routes/salesQualificationPilot.js' },
  { method: 'GET', path: '/leads/:id/deal-workflow', reason: 'Business OS pilot: đọc trạng thái Deal → Khảo sát → Thiết kế', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/deal-workflow/start-survey', reason: 'Business OS pilot: bắt đầu Khảo sát có idempotency', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/deal-workflow/start-design-review', reason: 'Business OS pilot: chọn nhánh khách đã có thiết kế', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/deal-workflow/complete-survey', reason: 'Business OS pilot: task gate Khảo sát và bàn giao Thiết kế', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/deal-workflow/complete-design', reason: 'Business OS pilot: task gate hoàn tất Thiết kế', file: 'routes/salesQualificationPilot.js' },
  { method: 'POST', path: '/leads/:id/deal-workflow/complete-design-review', reason: 'Business OS pilot: task gate thiết kế khách cung cấp', file: 'routes/salesQualificationPilot.js' },
];
