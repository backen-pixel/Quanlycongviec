/** Migration 583: Invoice payment terms. */
const fs = require('fs');
...
const sql = fs.readFileSync(
  path.join(__dirname, '..', '..', 'database', '583_invoice_payment_terms.sql'),
  'utf8',
);
...
async function main() {
  ...
  console.log(`Applying migration 583 to project ${projectRef}…`);
