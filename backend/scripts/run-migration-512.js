/**
 * Chạy migration 512 (time_scope day_cycle) trên Primary và Backup.
 * Usage: node scripts/run-migration-512.js
 */
const fs = require('fs');
...
const SQL_FILE = path.join(__dirname, '..', '..', 'database', '512_ai_bot_time_scope_day_cycle.sql');
