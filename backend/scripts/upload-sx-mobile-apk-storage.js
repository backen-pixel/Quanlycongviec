/**
 * Upload APK sx-mobile lên Supabase Storage và gắn vào bản phát hành.
 * Dùng khi upload Render thất bại hoặc file_url trỏ /uploads/... nhưng server chưa có file.
 *
 *   node scripts/upload-sx-mobile-apk-storage.js
 *   PUB_VERSION=1.0.57 PUB_CODE=60 node scripts/upload-sx-mobile-apk-storage.js
 */
const fs = require('fs');
...
const VERSION = process.env.PUB_VERSION || '1.0.57';
const VERSION_CODE = parseInt(process.env.PUB_CODE || '60', 10);
