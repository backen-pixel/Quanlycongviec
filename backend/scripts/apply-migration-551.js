/**
 * Apply database/551_shared_workspace_phat_sinh_kinds.sql via Management API.
 * Usage: node scripts/apply-migration-551.js
 */
...
async function main() {
  ...
  const query = fs.readFileSync(
    path.join(__dirname, '../../database/551_shared_workspace_phat_sinh_kinds.sql'),
    'utf8',
  );
  ...
  const verify = `
SELECT name, slug, sla_mode, sla_days, cutoff_time
