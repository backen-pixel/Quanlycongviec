/**
 * Apply database/550_users_zalo_id.sql via Management API.
 * Usage: node scripts/apply-migration-550.js
 */
...
async function main() {
  ...
  const query = fs.readFileSync(
    path.join(__dirname, '../../database/550_users_zalo_id.sql'),
    'utf8',
  );
...
WHERE table_schema = 'public' AND table_name = 'users' AND column_name = 'zalo_id';
`;
