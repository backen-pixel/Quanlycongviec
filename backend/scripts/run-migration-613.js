/**
 * 613: production_pipeline_stages.group_sort — thứ tự cột lớn.
 * Usage: node scripts/run-migration-613.js
 */
const fs = require('fs');
...
const SQL = fs.readFileSync(
  path.join(__dirname, '..', '..', 'database', '613_production_pipeline_group_sort.sql'),
  'utf8',
).split('-- HOÀN TÁC:')[0];
