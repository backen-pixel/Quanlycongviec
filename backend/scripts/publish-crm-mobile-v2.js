...
const VERSION = process.env.PUB_VERSION || '2.0.48';
const VERSION_CODE = parseInt(process.env.PUB_CODE || '49', 10);
...
const RELEASE_NOTES =
  ...
  || 'Bình luận: trả lời, cảm xúc, xóa, @ thành viên. Phân tách rõ nhiệm vụ/checklist. Gallery ảnh trong app.';
