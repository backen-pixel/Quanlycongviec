...
const VERSION = process.env.PUB_VERSION || '2.0.51';
const VERSION_CODE = parseInt(process.env.PUB_CODE || '52', 10);
...
const RELEASE_NOTES =
  ...
  || 'Sửa thông báo cuộc gọi đến Web↔App: FCM v2, chuông/rung, màn cuộc gọi native khi app tắt.';
