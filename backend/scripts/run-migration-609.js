/**
 * 609: HCB — bổ sung đủ NV mặc định phân loại vào đội SX.
 * Usage: node scripts/run-migration-609.js
 */
const fs = require('fs');
...
const SQL = fs.readFileSync(
  path.join(__dirname, '..', '..', 'database', '609_hcb_fill_workshop_type_staff.sql'),
  'utf8',
);
