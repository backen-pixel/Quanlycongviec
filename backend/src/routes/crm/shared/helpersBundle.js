...
const CRM_LEAD_LIST_SELECT_EXTRA = ', linked_project:projects!crm_leads_project_id_fkey(id, code, name, vc_handover_status, order_date, delivery_date, install_date, production_deadline, production_note, pickup_at, pickup_notes, vc_notes, logistics_company_id, delivery_team_id, installation_team_id, logistics_company:companies!projects_logistics_company_id_fkey(id, name, short_name))';
