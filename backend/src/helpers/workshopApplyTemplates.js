...
async function applyWorkshopTemplateToProject(projectId, templateId, userId) {
  ...
  const now = Date.now();
  /** Ngày hẹn: NV tự đặt trên từng task — không gán due_date khi gắn bộ mẫu. */
...
/** Ngày hẹn do NV tự đặt — không gán due_date khi hoàn thành nhiệm vụ trước trong chuỗi bộ mẫu. */
