...
export const FLOATING_BUBBLE_HIDDEN_KEY = 'sx_floating_chat_bubble_drop_hidden_v1';
export const FLOATING_BUBBLE_POS_KEY = 'sx_floating_chat_bubble_xy_v1';
export const FLOATING_BUBBLE_CLEAR_HIDDEN_EVENT = 'sx-floating-bubble-clear-hidden';
