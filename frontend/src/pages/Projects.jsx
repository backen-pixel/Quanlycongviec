                ...
                <div key={col.id} className="flex flex-col">
                  ...
                  <div className="flex-1 rounded-b-xl border p-2 space-y-3 bg-gray-50/50 overflow-y-auto" style={{ minHeight: '400px', maxHeight: '70vh' }}>
                    {projectsByStatus[col.id].map(proj => (
                      <Link to={`/projects/${proj.id}`} key={proj.id} className="block bg-white rounded-xl border border-gray-200 p-4 hover:shadow-lg hover:border-blue-300 transition-all group">
                        {/* Header: Code + Stage */}
