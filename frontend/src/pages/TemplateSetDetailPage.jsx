...
export default function TemplateSetDetailPage() {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      try {
        // Get set info first to know company
        ...
        // Get stages — prefer company-specific, fallback to all
        ...
        // If company has no stages, load default (chung)
  ...
  return (
    <div className="space-y-5 max-w-5xl">
      ...
      {/* Tasks grouped by stage — numbered from 1 */}
...
/* ═══ STAGE SECTION ═══ */
function StageSection({ stage, stageNumber, tasks, onUpdateTask, onDeleteTask, onAddChecklist, onDeleteChecklist }) {
...
/* ═══ TASK CARD ═══ */
function TaskCard({ task, onUpdate, onDelete, onAddChecklist, onDeleteChecklist }) {
