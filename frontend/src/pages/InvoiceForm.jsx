            ...
            <tbody>
              {(() => { let itemNo = 0; return items.map((item, idx) => {
                ...
                return (
                  ...
                  <tr className="border-b hover:bg-purple-50/30">
                    <td className="py-1 px-1 text-gray-400 text-xs">{itemNo}</td>
                    <td className="py-1 px-1"><input value={item.product_code || ''} onChange={e => updateItem(idx, 'product_code', e.target.value)} placeholder="Mã" className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent" /></td>
                    ...
                    <td className="py-1 px-1"><input value={item.description || ''} onChange={e => updateItem(idx, 'description', e.target.value)} placeholder="Mô tả" className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent" /></td>
                    <td className="py-1 px-1"><input value={item.unit} onChange={e => updateItem(idx, 'unit', e.target.value)} className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-center" /></td>
                    <td className="py-1 px-1"><NumericInput value={item.height || ''} onChange={v => updateItem(idx, 'height', v)} placeholder="mm" title="Cao (mm)" allowEmpty className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-right" /></td>
                    ...
                    <td className="py-1 px-1"><NumericInput value={item.quantity} onChange={v => updateItem(idx, 'quantity', v)} placeholder="1" className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-right" /></td>
                    <td className="py-1 px-1"><NumericInput value={item.unit_price} onChange={v => updateItem(idx, 'unit_price', v)} placeholder="0" className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-right" /></td>
                    <td className="py-1 px-1"><NumericInput value={item.discount_percent || 0} onChange={v => updateItem(idx, 'discount_percent', v)} className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-right" /></td>
                    ...
                    <td className="py-1 px-1 text-right text-xs font-medium whitespace-nowrap text-gray-900">
                      {item.is_freebie || item.notes === 'HỖ TRỢ' ? (
                        ...
                        <NumericInput
                          ...
                          className={`w-full px-1.5 py-1 border ${item.lock_amount ? 'border-emerald-400 text-emerald-700 font-semibold' : 'border-gray-200 hover:border-gray-400'} focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-right`}
                        />
                      )}
                    </td>
                    <td className="py-1 px-1"><NumericInput value={item.vat_rate || 0} onChange={v => updateItem(idx, 'vat_rate', v)} className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent text-right" /></td>
                    <td className="py-1 px-1 text-right text-xs text-gray-600 whitespace-nowrap">{formatVND(row.tax_amount || 0)}</td>
                    <td className="py-1 px-1 text-right text-xs font-bold whitespace-nowrap text-purple-700">{formatVND(row.total || 0)}</td>
                    <td className="py-1 px-1"><input value={item.promo_code || ''} onChange={e => updateItem(idx, 'promo_code', e.target.value)} placeholder="" className="w-full px-1.5 py-1 border border-gray-200 hover:border-gray-400 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded text-xs outline-none bg-transparent" /></td>
