...
export default function ProductsPage() {
  ...
  return (
    <div className="space-y-4">
      {/* Header */}
      <div data-guide-khu-vuc="Tiêu đề & thao tác sản phẩm" className="flex flex-wrap items-center justify-between gap-3">
        <div>
      ...
      {/* Search */}
      <div data-guide-khu-vuc="Tìm kiếm sản phẩm" className="relative">
      ...
      {categories.length > 0 && (
        <div data-guide-khu-vuc="Lọc theo nhóm ngành" className="flex gap-2 overflow-x-auto pb-1">
      ...
      <div data-guide-khu-vuc="Danh sách sản phẩm" className="bg-white rounded-xl border overflow-hidden">
