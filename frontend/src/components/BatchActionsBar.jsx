      ...
      {expanded && (
        <div className="border-t border-gray-100 px-4 pb-4 space-y-3">
          ...
          <p className="text-[10px] text-gray-500 leading-relaxed bg-gray-50 rounded-lg px-2 py-1.5 border border-gray-100">
            Thứ tự xử lý (chạy tay <strong>và</strong> Auto pipeline): <strong>liên hệ có hoạt động mới nhất trước</strong> (theo tin nhắn / thời tạo contact), tới cũ hơn. Đồng bộ <strong>smart</strong>: bỏ qua hội thoại KH <strong>không có tin inbound</strong> quá <strong>48 giờ</strong> (giảm gọi Facebook API). Chạy tay «Đồng bộ tin nhắn» (full) vẫn quét đủ. Cần chạy SQL <code className="text-[9px]">50_fb_last_inbound_rpc.sql</code> trên DB.
          </p>
