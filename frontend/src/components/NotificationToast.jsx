...
export default function NotificationToast({ notification, onDismiss, onNavigate }) {
  ...
  const COLORS = {
    ...
    production_task_deadline_warning: 'bg-amber-50 border-amber-200',
    production_task_deadline_overdue: 'bg-red-50 border-red-200',
    logistics_task_deadline_warning: 'bg-amber-50 border-amber-200',
    logistics_task_deadline_overdue: 'bg-red-50 border-red-200',
    project_pipeline_deadline_warning: 'bg-amber-50 border-amber-200',
    project_pipeline_deadline_overdue: 'bg-red-50 border-red-200',
