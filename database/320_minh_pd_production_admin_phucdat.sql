-- 320: Gắn minh@pd.com — NV CRM + Admin Sản xuất công ty Phúc Đạt
-- Role: crm_production_staff (CRM nhân viên; SX admin — xem 322 nếu cần chạy lại)
...
WHERE ur.role_id = r.id
  ...
  AND r.name IN ('crm_production_admin', 'production_admin', 'production_staff', 'staff');
