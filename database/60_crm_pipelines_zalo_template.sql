-- Zalo OA: mẫu tin theo từng pipeline CRM (bảng crm_pipelines tạo bởi database/21_crm_pipelines.sql).
-- Nếu bảng chưa tồn tại: chạy 21_crm_pipelines.sql trước, rồi chạy lại file này (an toàn, không báo lỗi 42P01).
