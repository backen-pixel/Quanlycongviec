...
VALUES (
  'd2000008-0000-0000-0000-000000000001',
  'Thao tác chi tiết VC/LĐ — từng nút trên dự án lắp đặt',
  'thao-tac-chi-tiet-vc-ld',
  'Dành cho tổ vận chuyển/lắp đặt. Học từng nút trên trang chi tiết dự án Lắp đặt (cùng giao diện xưởng, khác vài nút).',
  '🔧',
  43,
  true
)
...
UPDATE knowledge_categories SET
  ...
  certificate_template = $ct${"signature_name": "Ban điều hành TuBep Pro", "signature_title": "Phụ trách đào tạo vận hành", "footer_note": "Chứng nhận đã nắm từng nút trên trang chi tiết dự án VC/LĐ.", "accent_color": "#c026d3"}$ct$::jsonb
WHERE id = 'd2000008-0000-0000-0000-000000000001';
...
INSERT INTO knowledge_lessons (
  ...
  'b2000008-0000-0000-0000-000000000001',
  'd2000008-0000-0000-0000-000000000001',
  'Bài 1: Toàn cảnh trang chi tiết Lắp đặt',
  'Ba vùng giống CRM: header, cột trái Thông tin, hàng tab. Trang /vc/projects/:id.',
  $md_b2000008_0000_0000_0000_000000000001$# Bài 1: Toàn cảnh trang chi tiết Lắp đặt

> _Cùng một kiểu trang với CRM — học một lần, sang module kia vẫn biết chỗ bấm._

## 1. Ba vùng

Trang `/vc/projects/:id` (file `ProductionDetail`, badge **VC**).

1. **Header** — tên dự án/deal, nút riêng module, **Dự án đầy đủ**, **CRM deal**.
2. **Cột trái Thông tin** — ngày, địa chỉ, đội ngũ Lắp đặt.
3. **Hàng tab phải** — Công việc, Không gian chung, Tài liệu, Drive, Ghi chú, Bình luận, Sự cố, Thành viên. 

Có banner tím **Lắp đặt tạm** nếu Sale đã lên kế hoạch mà xưởng chưa bàn giao — thẻ bị khoá chuyển cột.

SX và VC **dùng chung giao diện**. Khác nhau ở vài nút header và 2 tab chỉ xưởng (Vật tư, Gửi duyệt).

![Minh họa luồng xưởng / lắp đặt](/uploads/knowledge-screenshots/sx-vc-07-board-cot-tam.png)
...
Bài sau: nút header và cột trái đúng module Lắp đặt.
$md_b2000008_0000_0000_0000_000000000001$,
  '/uploads/knowledge-screenshots/sx-vc-07-board-cot-tam.png',
  $att_b2000008_0000_0000_0000_000000000001$[{"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-07-board-cot-tam.png", "caption": "Minh họa Lắp đặt"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-03-nut-ke-hoach.png", "caption": "Deal CRM cùng đơn — để đối chiếu"}]$att_b2000008_0000_0000_0000_000000000001$::jsonb,
  8,
  ARRAY['chi-tiet', 'vc-ld', 'bai-1'],
  true,
  1,
  true,
  now()
...
INSERT INTO knowledge_lessons (
  ...
  'b2000008-0000-0000-0000-000000000002',
  'd2000008-0000-0000-0000-000000000001',
  'Bài 2: Nút header và cột trái Lắp đặt',
  'Từng nút riêng module trên header và Thông tin — SX có Đặt xưởng / bàn giao VC; VC có LĐ tạm và đội lắp.',
  $md_b2000008_0000_0000_0000_000000000002$# Bài 2: Nút header và cột trái Lắp đặt

> _Nhìn đúng badge VC trước khi bấm — đừng thao tác nhầm module._
...
$md_b2000008_0000_0000_0000_000000000002$,
  '/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png',
  $att_b2000008_0000_0000_0000_000000000002$[{"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-08-sx-ban-giao.png", "caption": "Xưởng — bước bàn giao"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png", "caption": "Thẻ TẠM phía VC"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-09-the-ban-giao.png", "caption": "Sale xác nhận trên CRM"}]$att_b2000008_0000_0000_0000_000000000002$::jsonb,
  14,
  ARRAY['chi-tiet', 'vc-ld', 'bai-2'],
  true,
  2,
  true,
  now()
...
INSERT INTO knowledge_lessons (
  ...
  'b2000008-0000-0000-0000-000000000003',
  'd2000008-0000-0000-0000-000000000001',
  'Bài 3: Tab Công việc — mẫu, thêm việc, xong hết',
  'Cùng nút với CRM: **Gắn mẫu VC/LĐ**, Thêm việc, Xong hết, List/Deadline/Planner/Lịch.',
  $md_b2000008_0000_0000_0000_000000000003$# Bài 3: Tab Công việc — mẫu, thêm việc, xong hết

> _Thanh nút giống CRM — chỉ khác bộ mẫu Lắp đặt._

## 1. Mở tab Công việc

Cùng component với CRM. Trên Lắp đặt bạn thấy việc của khối mình.

## 2. Từng nút (cùng tên với CRM)

1. **Gắn mẫu VC/LĐ** — gắn đúng bộ mẫu Lắp đặt.
...
5. Từng dòng: hoàn thành, hạn, file, checklist, **Giao việc VC**.

Nếu dự án chưa gắn CRM deal, có panel mẫu xưởng/VC thay thế — vẫn **Gắn mẫu**, **Thêm việc**.

## 3. Lỗi hay gặp

- Gắn mẫu CRM trên trang xưởng — chọn mẫu **Lắp đặt**.
- Bấm Xong hết khi việc ngoài hiện trường chưa xong.

---

Bài sau: Không gian chung và Thành viên (giống CRM).
$md_b2000008_0000_0000_0000_000000000003$,
  '/uploads/knowledge-screenshots/lead-05-nhiem-vu.png',
  $att_b2000008_0000_0000_0000_000000000003$[{"type": "image", "url": "/uploads/knowledge-screenshots/lead-05-nhiem-vu.png", "caption": "Tab Công việc — cùng UI CRM"}]$att_b2000008_0000_0000_0000_000000000003$::jsonb,
  12,
  ARRAY['chi-tiet', 'vc-ld', 'bai-3'],
  true,
  3,
  true,
  now()
...
INSERT INTO knowledge_lessons (
  ...
  'b2000008-0000-0000-0000-000000000004',
  'd2000008-0000-0000-0000-000000000001',
  'Bài 4: Không gian chung và Thành viên',
  'Cùng nút với CRM: Thêm giao việc, lọc khối, thêm thành viên.',
  $md_b2000008_0000_0000_0000_000000000004$# Bài 4: Không gian chung và Thành viên

> _Cùng tab với CRM — trên Lắp đặt lọc mặc định nghiêng về khối mình._
...
$md_b2000008_0000_0000_0000_000000000004$,
  '/uploads/knowledge-screenshots/collab-01.png',
  $att_b2000008_0000_0000_0000_000000000004$[{"type": "image", "url": "/uploads/knowledge-screenshots/collab-01.png", "caption": "Không gian chung"}, {"type": "image", "url": "/uploads/knowledge-screenshots/collab-05.png", "caption": "Giao việc"}]$att_b2000008_0000_0000_0000_000000000004$::jsonb,
  10,
  ARRAY['chi-tiet', 'vc-ld', 'bai-4'],
  true,
  4,
  true,
  now()
...
INSERT INTO knowledge_lessons (
  ...
  'b2000008-0000-0000-0000-000000000005',
  'd2000008-0000-0000-0000-000000000001',
  'Bài 5: Tài liệu, Drive, Ghi chú, Bình luận, Sự cố',
  'Cùng nút file/ghi chú với CRM, thêm Báo sự cố. Bình luận chứa dấu vết bàn giao.',
  $md_b2000008_0000_0000_0000_000000000005$# Bài 5: Tài liệu, Drive, Ghi chú, Bình luận, Sự cố

> _File bản vẽ phải chia sẻ đúng khối — Lắp đặt mới thấy._
...
$md_b2000008_0000_0000_0000_000000000005$,
  '/uploads/knowledge-screenshots/deal-05-hop-dong.png',
  $att_b2000008_0000_0000_0000_000000000005$[{"type": "image", "url": "/uploads/knowledge-screenshots/deal-05-hop-dong.png", "caption": "Tài liệu"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-09-the-ban-giao.png", "caption": "Kết quả bàn giao phía Sale"}]$att_b2000008_0000_0000_0000_000000000005$::jsonb,
  12,
  ARRAY['chi-tiet', 'vc-ld', 'bai-5'],
  true,
  5,
  true,
  now()
...
INSERT INTO knowledge_lessons (
  ...
  'b2000008-0000-0000-0000-000000000006',
  'd2000008-0000-0000-0000-000000000001',
  'Bài 6: Nút riêng Lắp đặt và thực hành cả trang',
  'Nút chỉ có trên Lắp đặt, phiếu tự kiểm, thi cuối nhận chứng nhận.',
  $md_b2000008_0000_0000_0000_000000000006$# Bài 6: Nút riêng VC/LĐ và thực hành cả trang
...
$md_b2000008_0000_0000_0000_000000000006$,
  '/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png',
  $att_b2000008_0000_0000_0000_000000000006$[{"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png", "caption": "Thực hành Lắp đặt"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-09b-chon-ban-giao.png", "caption": "Sale xác nhận trên CRM — biết kết quả"}]$att_b2000008_0000_0000_0000_000000000006$::jsonb,
  25,
  ARRAY['chi-tiet', 'vc-ld', 'bai-6'],
  true,
  6,
  true,
  now()
...
UPDATE knowledge_lessons SET is_final_exam = true WHERE id = 'b2000008-0000-0000-0000-000000000006';
...
INSERT INTO knowledge_exercises (
  ...
  'c2000008-0000-0000-0000-000000000003',
  'b2000008-0000-0000-0000-000000000003',
  'Bài kiểm tra: Tab Công việc — mẫu, thêm việc, xong hết',
  '10 câu — một số có ảnh. Đạt 70%, tối đa 3 lượt.',
  'quiz',
  $j_c2000008_0000_0000_0000_000000000003${"items": [{"id": "t1", "question": "Tab Công việc SX/VC khác CRM chủ yếu ở?", "type": "single", "options": ["Màu nút Xóa", "Bộ mẫu và nhãn Giao việc theo khối", "Không có Thêm việc", "Không có List"], "correct": [1], "explanation": "Cùng CRMTasksTab."}, {"id": "t2", "question": "Thêm việc làm gì?", "type": "single", "options": ["Tạo deal", "Thêm nhiệm vụ trong nhóm đang mở", "Xóa dự án", "Đổi công ty"], "correct": [1], "explanation": "Giống CRM."}, {"id": "t3", "question": "Xong hết nên bấm khi?", "type": "single", "options": ["Đầu ca", "Nhóm việc thật sự đã xong", "Khi thẻ còn TẠM", "Mỗi giờ"], "correct": [1], "explanation": "Giống CRM."}, {"id": "t4", "question": "Gắn mẫu VC/LĐ dùng trên trang nào?", "type": "single", "options": ["Chỉ CRM lead", "Chi tiết dự án VC/LĐ (hoặc pack VC trên deal)", "KPI", "Thùng rác"], "correct": [1], "explanation": "VC templates."}, {"id": "t5", "question": "List / Deadline / Planner / Lịch là?", "type": "single", "options": ["4 khoá học", "4 cách xem cùng list việc", "4 xưởng", "4 Sale"], "correct": [1], "explanation": "View switcher."}, {"id": "t6", "question": "Giao việc VC trên dòng việc mở gì?", "type": "single", "options": ["Login", "Bảng giao việc của khối", "MISA", "Facebook"], "correct": [1], "explanation": "Assignments."}, {"id": "t7", "question": "Bổ sung thiếu SX có trên VC không?", "type": "single", "options": ["Luôn", "Đó là nút pack xưởng — trên VC dùng Gắn mẫu VC/LĐ", "Bắt buộc VC", "Xóa việc"], "correct": [1], "explanation": "Khác nhãn."}, {"id": "t8", "question": "Không có CRM deal thì tab Công việc?", "type": "single", "options": ["Trống vĩnh viễn", "Dùng panel mẫu xưởng/VC: Gắn mẫu, Thêm việc", "Tự tạo Lead", "Đổi sang Đặt hàng"], "correct": [1], "explanation": "Workshop fallback."}, {"id": "t9", "question": "Học viên CRM và xưởng cùng thấy Thêm việc vì?", "type": "single", "options": ["Copy nhầm", "Hai module dùng cùng tab Công việc", "Bug", "Chỉ admin thấy"], "correct": [1], "explanation": "Shared UI."}, {"id": "t10", "question": "Phiếu khảo sát Sale nằm tab Công việc CRM — xưởng có phải điền không?", "type": "single", "options": ["Bắt buộc mọi thợ", "Đó là phiếu Sale; xưởng làm việc mẫu xưởng", "Xóa phiếu", "Chỉ VC điền"], "correct": [1], "explanation": "Đúng vai."}]}$j_c2000008_0000_0000_0000_000000000003$::jsonb,
  70,
  3,
  15,
  1,
  '/uploads/knowledge-screenshots/lead-05-nhiem-vu.png',
  $eax_c2000008_0000_0000_0000_000000000003$[{"type": "image", "url": "/uploads/knowledge-screenshots/lead-05-nhiem-vu.png", "caption": "Tab Công việc — cùng UI CRM"}]$eax_c2000008_0000_0000_0000_000000000003$::jsonb
) ON CONFLICT (id) DO UPDATE SET
  lesson_id = EXCLUDED.lesson_id, title = EXCLUDED.title, instructions = EXCLUDED.instructions,
  type = EXCLUDED.type, questions = EXCLUDED.questions, passing_score = EXCLUDED.passing_score,
  max_attempts = EXCLUDED.max_attempts, time_limit_minutes = EXCLUDED.time_limit_minutes,
...
INSERT INTO knowledge_exercises (
  ...
  'c2000008-0000-0000-0000-000000000005',
  'b2000008-0000-0000-0000-000000000005',
  'Bài kiểm tra: Tài liệu, Drive, Ghi chú, Bình luận, Sự cố',
  '12 câu — một số có ảnh. Đạt 70%, tối đa 3 lượt.',
  'quiz',
  $j_c2000008_0000_0000_0000_000000000005${"items": [{"id": "d1", "question": "Xưởng không thấy bản vẽ CRM — hay vì?", "type": "single", "options": ["Hết dung lượng Zalo", "File chưa chia sẻ sang khối SX", "Sai mật khẩu", "Thiếu KPI"], "correct": [1], "explanation": "Share."}, {"id": "d2", "question": "Tải tất cả làm gì?", "type": "single", "options": ["Xóa", "ZIP tài liệu", "Tạo Lead", "Đổi cột"], "correct": [1], "explanation": "ZIP."}, {"id": "d3", "question": "Tab Sự cố có trên chi tiết CRM không?", "type": "single", "options": ["Có, tên Ghi âm", "Không — Sự cố ở trang SX/VC", "Chỉ Lead", "Chỉ khi thắng"], "correct": [1], "explanation": "SX/VC."}, {"id": "d4", "question": "Báo sự cố các bước?", "type": "single", "options": ["Xóa dự án", "Báo sự cố → điền → Gửi báo cáo; xong thì Đã xử lý", "Import Excel", "Chuyển Deal"], "correct": [1], "explanation": "Incident CRUD."}, {"id": "d5", "question": "Chọn & bàn giao ai bấm, ở đâu?", "type": "single", "options": ["Thợ VC trên trang VC", "Sale trên CRM tab Bình luận", "Kế toán tab Đặt hàng", "Admin theme"], "correct": [1], "explanation": "Khóa 534."}, {"id": "d6", "question": "Nhập văn bản tạo gì?", "type": "single", "options": ["User", "Tài liệu chữ trên hệ thống", "Cột Kanban", "PO"], "correct": [1], "explanation": "Text doc."}, {"id": "d7", "question": "Chia sẻ CRM trên file xưởng để?", "type": "single", "options": ["Xóa file", "Sale đọc được file từ khối xưởng", "Đổi xưởng", "In lương"], "correct": [1], "explanation": "Share reverse."}, {"id": "d8", "question": "Ghi chú Gửi nhanh?", "type": "single", "options": ["F1", "Ctrl+Enter", "Shift+F5", "Esc"], "correct": [1], "explanation": "Giống CRM."}, {"id": "d9", "question": "Drive tab dùng khi?", "type": "single", "options": ["File Google Drive gắn dự án", "Đổi pipeline", "KPI", "Login"], "correct": [0], "explanation": "Drive."}, {"id": "d10", "question": "Bình luận Trả lời / Sửa / Xóa là?", "type": "single", "options": ["Xóa dự án", "Thao tác từng comment", "Bàn giao VC tự động", "Tạo sự kiện"], "correct": [1], "explanation": "Comments."}, {"id": "d11", "question": "Sự cố không ghi trên app thì?", "type": "single", "options": ["Vẫn vào báo cáo", "Mất vết, quản lý không thấy", "KPI tăng", "Tự tạo Lead"], "correct": [1], "explanation": "Ghi app."}, {"id": "d12", "question": "Upload file xưởng khác Upload CRM?", "type": "single", "options": ["Khác chỗ bấm, cùng ý: đưa file vào đơn", "Xóa deal", "Chỉ PDF", "Chỉ admin VC"], "correct": [0], "explanation": "Cùng ý."}]}$j_c2000008_0000_0000_0000_000000000005$::jsonb,
  70,
  3,
  15,
  1,
  '/uploads/knowledge-screenshots/deal-05-hop-dong.png',
  $eax_c2000008_0000_0000_0000_000000000005$[{"type": "image", "url": "/uploads/knowledge-screenshots/deal-05-hop-dong.png", "caption": "Tài liệu"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-09-the-ban-giao.png", "caption": "Kết quả bàn giao phía Sale"}]$eax_c2000008_0000_0000_0000_000000000005$::jsonb
) ON CONFLICT (id) DO UPDATE SET
  lesson_id = EXCLUDED.lesson_id, title = EXCLUDED.title, instructions = EXCLUDED.instructions,
  type = EXCLUDED.type, questions = EXCLUDED.questions, passing_score = EXCLUDED.passing_score,
  max_attempts = EXCLUDED.max_attempts, time_limit_minutes = EXCLUDED.time_limit_minutes,
...
INSERT INTO knowledge_exercises (
  ...
  'c2000008-0000-0000-0000-000000000006',
  'b2000008-0000-0000-0000-000000000006',
  'Bài kiểm tra cuối: Từng nút trên chi tiết Lắp đặt',
  'Làm xong phiếu tự kiểm rồi vào đây. 15 câu, một số có ảnh. Đạt 80%, tối đa 3 lượt, 25 phút.',
  'quiz',
  $j_c2000008_0000_0000_0000_000000000006${"items": [{"id": "f1", "question": "Đặt xưởng khác có trên VC không?", "type": "single", "options": ["Có", "Không", "Chỉ khi TẠM", "Chỉ thợ"], "correct": [1], "explanation": "SX-only."}, {"id": "f2", "question": "Tab Vật tư trên VC?", "type": "single", "options": ["Có", "Không — chỉ SX", "Chỉ admin", "Khi nghiệm thu"], "correct": [1], "explanation": "Hidden."}, {"id": "f3", "question": "Banner Lắp đặt tạm nghĩa là?", "type": "single", "options": ["Kéo cột tự do", "Chưa bàn giao thật — không kéo cột", "Hết việc", "Deal thua"], "correct": [1], "explanation": "Lock."}, {"id": "f4", "question": "Gắn mẫu VC/LĐ ở tab nào?", "type": "single", "options": ["Đặt hàng", "Công việc", "KPI", "Drive"], "correct": [1], "explanation": "Tasks."}, {"id": "f5", "question": "Ai bấm Chọn & bàn giao?", "type": "single", "options": ["Thợ VC trên trang này", "Sale trên CRM Bình luận", "Kế toán", "Mọi user"], "correct": [1], "explanation": "Sale."}, {"id": "f6", "question": "Sau khi hết TẠM, thẻ VC làm gì?", "type": "single", "options": ["Xóa", "Kéo theo tiến độ: chờ giao → đang giao → lắp → nghiệm thu", "Trả về Lead", "Tạo PO"], "correct": [1], "explanation": "Normal move."}, {"id": "f7", "question": "Người vận chuyển phụ trách chọn ở?", "type": "single", "options": ["Header cam", "Cột trái Thông tin", "App Switcher", "Thùng rác"], "correct": [1], "explanation": "Info panel."}, {"id": "f8", "question": "Sự cố Báo sự cố để?", "type": "single", "options": ["Tính lương", "Ghi sự cố công trình trên hệ thống", "Xóa dự án", "Import Excel"], "correct": [1], "explanation": "Incident."}, {"id": "f9", "question": "CRM deal trên header VC mở?", "type": "single", "options": ["Login", "Chi tiết Lead/Deal cùng đơn", "KPI giám đốc", "Theme"], "correct": [1], "explanation": "Link."}, {"id": "f10", "question": "Nhìn ảnh thẻ TẠM. Badge nghĩa là?", "type": "single", "options": ["Đã giao xong", "Khoá chuyển cột — chờ xưởng + Sale", "VIP", "Xóa được"], "correct": [1], "explanation": "TẠM.", "image_url": "/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png"}, {"id": "f11", "question": "Không gian chung Thêm là?", "type": "single", "options": ["Xóa đội", "Giao việc mới", "Đặt xưởng", "Gửi duyệt"], "correct": [1], "explanation": "Assign."}, {"id": "f12", "question": "Form kế hoạch ngày lắp học ở?", "type": "single", "options": ["Bài này đủ", "Khoá Kế hoạch SX & VC/LĐ", "Tab Sự cố", "MISA"], "correct": [1], "explanation": "534."}, {"id": "f13", "question": "Gửi duyệt có trên VC?", "type": "single", "options": ["Có", "Không — tab chỉ SX", "Chỉ khi TẠM", "Thay Sự cố"], "correct": [1], "explanation": "SX-only."}, {"id": "f14", "question": "Tải tất cả trên Tài liệu?", "type": "single", "options": ["Xóa ZIP", "Tải ZIP file", "Tạo Lead", "Đổi cột"], "correct": [1], "explanation": "ZIP."}, {"id": "f15", "question": "Kéo thẻ TẠM sang cột khác — đúng là?", "type": "single", "options": ["Thẻ chạy", "Hệ thống chặn", "Tạo dự án mới", "Xóa badge"], "correct": [1], "explanation": "Blocked."}]}$j_c2000008_0000_0000_0000_000000000006$::jsonb,
  80,
  3,
  25,
  1,
  '/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png',
  $eax_c2000008_0000_0000_0000_000000000006$[{"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png", "caption": "Thực hành Lắp đặt"}, {"type": "image", "url": "/uploads/knowledge-screenshots/sx-vc-09b-chon-ban-giao.png", "caption": "Sale xác nhận trên CRM — biết kết quả"}]$eax_c2000008_0000_0000_0000_000000000006$::jsonb
) ON CONFLICT (id) DO UPDATE SET
  lesson_id = EXCLUDED.lesson_id, title = EXCLUDED.title, instructions = EXCLUDED.instructions,
  type = EXCLUDED.type, questions = EXCLUDED.questions, passing_score = EXCLUDED.passing_score,
  max_attempts = EXCLUDED.max_attempts, time_limit_minutes = EXCLUDED.time_limit_minutes,
...
INSERT INTO knowledge_exercises (
  ...
  'c2000008-0000-0001-0000-000000000006',
  'b2000008-0000-0000-0000-000000000006',
  'Phiếu tự kiểm — thao tác trên dự án thật',
  'Đánh dấu khi đã làm được trên phần mềm. Hủy form nếu chỉ xem, đừng tạo dữ liệu rác.',
  'checklist',
  $j_c2000008_0000_0001_0000_000000000006${"items": [{"id": "c1", "text": "Mở chi tiết dự án VC: thấy badge VC và 3 vùng màn hình"}, {"id": "c2", "text": "Chỉ đúng banner Lắp đặt tạm nếu dự án còn TẠM"}, {"id": "c3", "text": "Header: biết nút CRM deal và Dự án đầy đủ — không có Đặt xưởng khác"}, {"id": "c4", "text": "Cột trái: chỉ chỗ chọn người/đội VC-LĐ"}, {"id": "c5", "text": "Tab Công việc: thấy Thêm việc hoặc Gắn mẫu VC/LĐ"}, {"id": "c6", "text": "Không gian chung: mở form Thêm rồi Hủy"}, {"id": "c7", "text": "Sự cố: thấy nút Báo sự cố"}, {"id": "c8", "text": "Hiểu: Chọn & bàn giao do Sale bấm trên CRM, không phải trên trang VC"}]}$j_c2000008_0000_0001_0000_000000000006$::jsonb,
  80,
  NULL,
  NULL,
  2,
  '/uploads/knowledge-screenshots/sx-vc-07b-the-tam-ghi-chu.png',
  $eax_c2000008_0000_0001_0000_000000000006$[]$eax_c2000008_0000_0001_0000_000000000006$::jsonb
) ON CONFLICT (id) DO UPDATE SET
  lesson_id = EXCLUDED.lesson_id, title = EXCLUDED.title, instructions = EXCLUDED.instructions,
  type = EXCLUDED.type, questions = EXCLUDED.questions, passing_score = EXCLUDED.passing_score,
  max_attempts = EXCLUDED.max_attempts, time_limit_minutes = EXCLUDED.time_limit_minutes,
